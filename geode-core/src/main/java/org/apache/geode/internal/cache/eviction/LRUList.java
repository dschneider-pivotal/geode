...
public interface LRUList {

  void setBucketRegion(Object r);
   ...
   */
  void appendEntry(LRUClockNode aNode);
   ...
   */
  LRUClockNode getLRUEntry();

  /** unsynchronized audit...only run after activity has ceased. */
  void audit();

  /** remove an entry from the list */
  boolean unlinkEntry(LRUClockNode entry);
  ...
  void clear(RegionVersionVector rvv);

  /**
   * Get size of LRU list
   *
   * @return size
   */
  int size();
