...
public class VMThinDiskLRURegionEntryOffHeapStringKey1 extends VMThinDiskLRURegionEntryOffHeap {
  ...
  private static final AtomicLongFieldUpdater<VMThinDiskLRURegionEntryOffHeapStringKey1> OFF_HEAP_ADDRESS_UPDATER =
      AtomicLongFieldUpdater.newUpdater(VMThinDiskLRURegionEntryOffHeapStringKey1.class, "offHeapAddress");
  ...
  public VMThinDiskLRURegionEntryOffHeapStringKey1 (final RegionEntryContext context, final String key,
