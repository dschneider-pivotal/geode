...
public class VersionedThinDiskRegionEntryOffHeapUUIDKey extends VersionedThinDiskRegionEntryOffHeap {
  ...
  private static final AtomicLongFieldUpdater<VersionedThinDiskRegionEntryOffHeapUUIDKey> OFF_HEAP_ADDRESS_UPDATER =
      AtomicLongFieldUpdater.newUpdater(VersionedThinDiskRegionEntryOffHeapUUIDKey.class, "offHeapAddress");
  ...
  public VersionedThinDiskRegionEntryOffHeapUUIDKey (final RegionEntryContext context, final UUID key,
