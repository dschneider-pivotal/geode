...
public class VersionedThinDiskRegionEntryOffHeapStringKey2 extends VersionedThinDiskRegionEntryOffHeap {
  ...
  private static final AtomicLongFieldUpdater<VersionedThinDiskRegionEntryOffHeapStringKey2> OFF_HEAP_ADDRESS_UPDATER =
      AtomicLongFieldUpdater.newUpdater(VersionedThinDiskRegionEntryOffHeapStringKey2.class, "offHeapAddress");
  ...
  public VersionedThinDiskRegionEntryOffHeapStringKey2 (final RegionEntryContext context, final String key,
