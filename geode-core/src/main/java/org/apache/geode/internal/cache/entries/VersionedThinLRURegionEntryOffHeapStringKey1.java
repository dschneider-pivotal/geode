...
public class VersionedThinLRURegionEntryOffHeapStringKey1 extends VersionedThinLRURegionEntryOffHeap {
  ...
  private static final AtomicLongFieldUpdater<VersionedThinLRURegionEntryOffHeapStringKey1> OFF_HEAP_ADDRESS_UPDATER =
      AtomicLongFieldUpdater.newUpdater(VersionedThinLRURegionEntryOffHeapStringKey1.class, "offHeapAddress");
  ...
  public VersionedThinLRURegionEntryOffHeapStringKey1 (final RegionEntryContext context, final String key,
