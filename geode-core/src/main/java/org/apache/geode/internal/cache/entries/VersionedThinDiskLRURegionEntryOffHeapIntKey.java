...
public class VersionedThinDiskLRURegionEntryOffHeapIntKey extends VersionedThinDiskLRURegionEntryOffHeap {
  ...
  private static final AtomicLongFieldUpdater<VersionedThinDiskLRURegionEntryOffHeapIntKey> OFF_HEAP_ADDRESS_UPDATER =
      AtomicLongFieldUpdater.newUpdater(VersionedThinDiskLRURegionEntryOffHeapIntKey.class, "offHeapAddress");
  ...
  public VersionedThinDiskLRURegionEntryOffHeapIntKey (final RegionEntryContext context, final int key,
