...
public class VersionedStatsDiskRegionEntryOffHeapLongKey extends VersionedStatsDiskRegionEntryOffHeap {
  ...
  private static final AtomicLongFieldUpdater<VersionedStatsDiskRegionEntryOffHeapLongKey> OFF_HEAP_ADDRESS_UPDATER =
      AtomicLongFieldUpdater.newUpdater(VersionedStatsDiskRegionEntryOffHeapLongKey.class, "offHeapAddress");
  ...
  public VersionedStatsDiskRegionEntryOffHeapLongKey (final RegionEntryContext context, final long key,
