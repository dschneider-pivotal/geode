...
public class VersionedThinDiskRegionEntryOffHeapStringKey1 extends VersionedThinDiskRegionEntryOffHeap {
  ...
  private static final AtomicLongFieldUpdater<VersionedThinDiskRegionEntryOffHeapStringKey1> OFF_HEAP_ADDRESS_UPDATER =
      AtomicLongFieldUpdater.newUpdater(VersionedThinDiskRegionEntryOffHeapStringKey1.class, "offHeapAddress");
  ...
  public VersionedThinDiskRegionEntryOffHeapStringKey1 (final RegionEntryContext context, final String key,
