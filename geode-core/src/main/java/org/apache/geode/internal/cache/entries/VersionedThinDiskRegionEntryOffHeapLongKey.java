...
public class VersionedThinDiskRegionEntryOffHeapLongKey extends VersionedThinDiskRegionEntryOffHeap {
  ...
  private static final AtomicLongFieldUpdater<VersionedThinDiskRegionEntryOffHeapLongKey> OFF_HEAP_ADDRESS_UPDATER =
      AtomicLongFieldUpdater.newUpdater(VersionedThinDiskRegionEntryOffHeapLongKey.class, "offHeapAddress");
  ...
  public VersionedThinDiskRegionEntryOffHeapLongKey (final RegionEntryContext context, final long key,
