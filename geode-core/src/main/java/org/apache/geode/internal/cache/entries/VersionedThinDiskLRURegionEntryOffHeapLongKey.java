...
public class VersionedThinDiskLRURegionEntryOffHeapLongKey extends VersionedThinDiskLRURegionEntryOffHeap {
  ...
  private static final AtomicLongFieldUpdater<VersionedThinDiskLRURegionEntryOffHeapLongKey> OFF_HEAP_ADDRESS_UPDATER =
      AtomicLongFieldUpdater.newUpdater(VersionedThinDiskLRURegionEntryOffHeapLongKey.class, "offHeapAddress");
  ...
  public VersionedThinDiskLRURegionEntryOffHeapLongKey (final RegionEntryContext context, final long key,
